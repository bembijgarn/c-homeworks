...
namespace WebApplication8.Migrations
{
    ...
    [Migration("20221206011146_personz")]
    partial class personz
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication8.models.PersonAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebApplication8.models.PersonAccount", b =>
                {
                    b.HasOne("WebApplication8.models.Person", null)
                        .WithOne("Account")
                        .HasForeignKey("WebApplication8.models.PersonAccount", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
